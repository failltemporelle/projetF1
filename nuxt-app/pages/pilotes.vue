<template>
  ...
  <div class="flex flex-row flex-wrap place-content-center">
    <div class="p-4 " v-for="item in f1.points" :key="item.Driver.driverId">
      ...
      <div class="rounded-lg bg-card text-card-foreground bg-secondary card hover:skeleton"
        data-v0-t="card">
        ...
        <div class="flex flex-col space-y-1.5 p-6 items-center text-center ">
          ...
          <img :src="getUrl(item.Driver.driverId)" alt="Image du pilote" class="mx-auto lg:block hidden" width="200"
            height="100">
