...
//   import { GLTFLoader } from 'three/addons/loaders/GLTFLoader.js'; // Mettez à jour l'importation
//   import { OrbitControls } from 'three/addons/controls/OrbitControls.js'; // Mettez à jour l'importation
